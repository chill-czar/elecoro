...
const Hero = () => {
  return (
    <section className="flex min-h-screen w-full flex-col items-center justify-center bg-white px-4 pt-16 pb-24 text-center sm:px-6 lg:px-8">
      ...
      <p className="mt-6 max-w-2xl text-lg leading-relaxed font-light text-gray-500 sm:text-xl">
        ...
        one modular platform. Designed for modern contractors and distributors.
      </p>
      ...
      <div className="mt-10 flex w-full flex-col items-center gap-4 sm:w-auto sm:flex-row">
        ...
        {/* Secondary Button */}
        <button className="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-8 py-3.5 text-base font-bold text-[#111111] shadow-sm transition-colors hover:bg-gray-50 sm:w-auto">
